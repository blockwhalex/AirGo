    ...
    <div class="container layout-padding">
        <el-card shadow="hover" class="layout-padding-auto">
            ...
            <el-table :data="goodsList" height="100%" style="width: 100%;flex: 1;">
                ...
                <el-table-column prop="subject" label="套餐名称" show-overflow-tooltip></el-table-column>
                <el-table-column prop="total_amount" label="套餐价格(元)" show-overflow-tooltip></el-table-column>
                <el-table-column prop="total_bandwidth" label="总流量(GB)" show-overflow-tooltip></el-table-column>
                <el-table-column prop="expiration_date" label="有效期(天)" show-overflow-tooltip>
                </el-table-column>
